      ...
      <div className='w-9/10 container mx-auto pt-4 pb-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-7 pt-1 pb-6 px-4 md:px-0'>
          ...
          <div className='flex flex-col items-center justify-center py-20 text-center'>
            <h2 className='text-2xl font-semibold text-gray-700 mb-4'>No Sessions Yet</h2>
            <p className='text-gray-500 mb-8'>Create your first interview prep session to get started!</p>
            <button className='bg-linear-to-r from-[#7D1C4A] to-[#670D2F] text-white px-8 py-3 rounded-full font-semibold hover:shadow-lg transition' onClick={() => setOpenCreateModal(true)}>
